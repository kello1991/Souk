...
use SoukBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@Souk/categorie/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SoukBundle\Form\CategorieType', $categorie);
        ...
        return $this->render('@Souk/categorie/new.html.twig', array(
            'categorie' => $categorie,
    ...
    public function showAction(Categorie $categorie)
    {
        ...
        return $this->render('@Souk/categorie/show.html.twig', array(
            'categorie' => $categorie,
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('SoukBundle\Form\CategorieType', $categorie);
        ...
        return $this->render('@Souk/categorie/edit.html.twig', array(
            'categorie' => $categorie,
